...
им свои значения, остальные аргументы будут помещены в массив. 
Операция rest собирает все оставшиеся аргументы и поэтому должна
 идти последней в подписи функции, иначе будет ошибка.
...
Функция addOverNum() считает сумму всех аргументов. Измени параметры
 ...
 тех аргументов, которые больше чем заданное число. Это число 
...
function addOverNum(...args) {
  let total = 0;
console.log(...args);//10, 12, 4, 11, 48, 10, 8
...
// args[0] = 10
// перебор аргументов (10, 12, 4, 11, 48, 10, 8)  > 10 
//  12, 11, 48 = 71
    total += arg;
